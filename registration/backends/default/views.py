...
from ... import signals
from ...models import RegistrationProfile, Refer, ReferCodes
from ...views import ActivationView as BaseActivationView
from ...views import RegistrationView as BaseRegistrationView
from ...views import ReferRegistrationView as BaseReferRegistrationView
...
class ReferRegistrationView(BaseReferRegistrationView):
    ...
    * The creation of the templates
    ...
    def register(self, request, form, refer):
        """
        Given a username, email address and password, register a new
        user account, which will initially be inactive.
        ...
        referrer = ReferCodes.objects.get(code=refer).user
        obj, new = Refer.objects.get_or_create(referrer=referrer, referred=new_user_instance)
